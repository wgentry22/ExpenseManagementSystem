package io.gtrain.domain.validation;
...
public class RegistrationFormValidator implements Validator {
	...
	private final Pattern streetAddressPattern = Pattern.compile("^[a-zA-Z0-9\\s$]+$");
	...
	public void validate(Object o, Errors errors) {
		...
		if (!numericPattern.matcher(form.getZipCode()).matches())
			errors.rejectValue("zipCode", "zipCode.invalid");

		if (!streetAddressPattern.matcher(form.getStreet()).matches())
			errors.rejectValue("street", "street.invalid");

		if (!namePattern.matcher(form.getCity()).matches())
			errors.rejectValue("city", "city.invalid");

		if (!namePattern.matcher(form.getState()).matches())
			...
			for (RuleResultDetail detail : result.getDetails()) {
				switch (detail.getErrorCode()) {
					...
					case "TOO_LONG":
						...
						break;
					case "ILLEGAL_MATCH":
						errors.rejectValue("password", "password.repeated");
						break;
				}
			}
		}
